...
.avatar-circle.guest::before {
  content: '';
  position: absolute;
  inset: 0;
  background:
    radial-gradient(circle at 50% 38%, rgba(130,130,130,0.85) 0 20%, rgba(130,130,130,0) 22%),
    radial-gradient(ellipse at 50% 78%, rgba(130,130,130,0.70) 0 42%, rgba(130,130,130,0) 44%),
    radial-gradient(circle at 30% 25%, rgba(255,255,255,0.75), rgba(255,255,255,0) 55%);
  opacity: 0.95;
  filter: blur(0.6px);
}

.avatar-circle.guest:hover {
...
.nav-actions .cart-link:hover .cart-icon {
  filter: drop-shadow(0 3px 7px rgba(0,0,0,0.22));
}

 .nav-actions .notif-link {
  transform: none;
  width: 44px;
  height: 44px;
  border-radius: 14px;
 ...
 .nav-actions .notif-link:hover .notif-icon {
  color: #2f241b;
  transform: translateY(2px) rotate(-4deg) scale(1.04);
  filter: drop-shadow(0 3px 6px rgba(0,0,0,0.18));
 }

 .notif-link.has-unread .notif-icon {
  filter: drop-shadow(0 0 0 rgba(0,0,0,0)) drop-shadow(0 0 12px rgba(220, 0, 0, 0.38)) drop-shadow(0 2px 6px rgba(0,0,0,0.14));
 }
